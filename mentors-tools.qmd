...
- [Etherpad format](https://pad.riseup.net/): this is another accesible option with Markdown format for the text and don't need an account from users.  The cons is that it only available for some time (you can configure how many days from a list of options).  
